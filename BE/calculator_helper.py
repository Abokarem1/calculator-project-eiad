...
class CalculatorHelper():
    ...
    def add(self, a, b):
        ...
        result =  a + b
        self.logger.debug("Adding " + str(a)+ " to "+ str(b)+  "result" + str(result), extra=self.log_properties)
        return result
    ...
    def divide(self, a, b): 
        self.logger.debug("Dividing " + str(a)+ " by "+ str(b) , extra=self.log_properties)
        return a/b
